...
public class ExtentListeners implements ITestListener, ISuiteListener {
	...
	public void onTestFailure(ITestResult result) {
		...
		/*
		 * try { BaseTest.captureScreenshot(); } catch (IOException e) { // TODO
		 ...
		 * 
		 * 
		 * String screenshot = BaseTest.fileName;
		 * 
		 * test.fail("<b><font color=red>" + "Screenshot of failure" +
		 * "</font></b><br>",MediaEntityBuilder.createScreenCaptureFromPath(screenshot)
		 * .build());
		 * 
		 * 
		 * 
